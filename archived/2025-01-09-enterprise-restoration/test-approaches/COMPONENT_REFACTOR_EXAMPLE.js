    ...
    <div className="card">
      <div className="card-body">
        ...
        <button
          type="button"
          onClick={loadExample}
          className="btn btn-small btn-secondary mb-6"
        >
                  ...
                  <div className="form-group">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="form-input"
                      />
                      <span className="ml-3 text-sm font-medium" style={{ color: 'rgb(var(--text-secondary))' }}>%</span>
                    </div>
                  </div>
        ...
        <div className="flex justify-between gap-4 pt-6 border-t border-current" style={{ borderColor: 'rgb(var(--border))' }}>
          <button
            onClick={onPrevious}
