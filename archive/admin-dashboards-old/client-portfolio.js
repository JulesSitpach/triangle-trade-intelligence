      ...
      <div className="main-content">
        <div className="container-app">
          ...
          <div className="admin-nav-tabs">
            <button
              className={`admin-btn jorge ${activeTab === 'service-requests' ? 'active' : ''}`}
            ...
            <button
              className={`admin-btn jorge ${activeTab === 'partnership-intelligence' ? 'active' : ''}`}
              onClick={() => setActiveTab('partnership-intelligence')}
            >
              📊 Partnership Intelligence ($300/mo)
            </button>
            <button
            ...
            <button
              className={`admin-btn jorge ${activeTab === 'partner-applications' ? 'active' : ''}`}
              onClick={() => setActiveTab('partner-applications')}
            >
              🤝 Partner Applications
            </button>
            <button
              className={`admin-btn jorge ${activeTab === 'service-calendar' ? 'active' : ''}`}
              onClick={() => setActiveTab('service-calendar')}
            >
              📅 Service Calendar
            </button>
            <button
              className={`admin-btn jorge ${activeTab === 'client-management' ? 'active' : ''}`}
          ...
          {/* Service Requests Tab - Jorge's Active Service Queue */}
          {activeTab === 'service-requests' && (
            <div>
              {/* Service Requests Queue */}
              <div className="admin-card">
                <div className="card-header">
                  <h1 className="admin-title">📋 Jorge's Service Request Queue</h1>
                  <p className="admin-subtitle">
                    Active service requests for {new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                  </p>
                  <div className="service-capacity-indicator">
                    <span>Monthly Capacity: Supplier Vetting: {(supplierVettingQueue?.length || 0)}/10 | Market Entry: {(marketEntryConsultations?.length || 0)}/15 hours</span>
                  </div>
                </div>
          ...
          {activeTab === 'supplier-vetting' && (
            <div className="admin-card">
              <div className="card-header">
                <h1 className="admin-title">🏭 Supplier Vetting Queue ($750 per service)</h1>
                <p className="admin-subtitle">Mexico supplier introduction and vetting service management</p>
                <div className="service-capacity-indicator">
                  <span>Monthly Capacity: {(supplierVettingQueue?.length || 0)}/10 vetted suppliers</span>
                </div>
              </div>
              ...
              <div className="table-container">
                <table className="admin-table">
                  ...
                  <tbody>
                    {supplierVettingQueue?.map((item, index) => (
                      <tr key={index}>
                        <td>{item.client_company}</td>
                        <td>{item.product_category}</td>
                        <td>
                          <span className={`status-badge ${item.vetting_status?.toLowerCase()}`}>
                            {item.vetting_status}
                          </span>
                        </td>
                        <td>{item.mexico_region}</td>
                        <td className="font-mono text-green-600">$750</td>
                        <td>{item.due_date}</td>
                        <td>
                          <button className="admin-btn-sm primary" onClick={() => openSupplierVettingTools(item)}>
                            🔍 Vet Supplier
                          </button>
                          <button className="admin-btn-sm secondary" onClick={() => generateSupplierProfile(item)}>
                            📋 Generate Profile
                          </button>
                        </td>
                      </tr>
          ...
          {activeTab === 'market-entry' && (
            <div className="admin-card">
              <div className="card-header">
                <h1 className="admin-title">🎯 Market Entry Consultations ($400/hour)</h1>
                <p className="admin-subtitle">Mexico market entry strategy and consultation management</p>
                <div className="service-capacity-indicator">
                  <span>Monthly Capacity: {(marketEntryConsultations?.length || 0)}/15 consultation hours</span>
                </div>
              </div>
              ...
              <div className="table-container">
                <table className="admin-table">
                  ...
                  <tbody>
                    {marketEntryConsultations?.map((item, index) => (
                      <tr key={index}>
                        <td>{item.client_company}</td>
                        <td>{item.consultation_type}</td>
                        <td>{item.hours_scheduled}</td>
                        <td>
                          <span className={`status-badge ${item.status?.toLowerCase()}`}>
                            {item.status}
                          </span>
                        </td>
                        <td className="font-mono text-green-600">${(item.hours_scheduled || 0) * 400}</td>
                        <td>{item.next_session}</td>
                        <td>
                          <button className="admin-btn-sm primary" onClick={() => openMarketEntryTools(item)}>
                            📊 Strategy Tools
                          </button>
                          <button className="admin-btn-sm secondary" onClick={() => generateMarketEntryPlan(item)}>
                            📋 Generate Plan
                          </button>
                        </td>
                      </tr>
          ...
          {activeTab === 'partnership-intelligence' && (
            <div className="admin-card">
              <div className="card-header">
                <h1 className="admin-title">📊 Partnership Intelligence ($300/month)</h1>
                <p className="admin-subtitle">Monthly subscription service for Mexico trade intelligence</p>
                <div className="service-capacity-indicator">
                  <span>Active Subscriptions: {(partnershipIntelligence?.length || 0)}</span>
                </div>
              </div>
              ...
              <div className="table-container">
                <table className="admin-table">
                  ...
                  <tbody>
                    {partnershipIntelligence?.map((item, index) => (
                      <tr key={index}>
                        <td>{item.client_company}</td>
                        <td>{item.subscription_start}</td>
                        <td>{item.report_frequency}</td>
                        <td>
                          <span className={`status-badge ${item.status?.toLowerCase()}`}>
                            {item.status}
                          </span>
                        </td>
                        <td className="font-mono text-green-600">$300</td>
                        <td>{item.next_report}</td>
                        <td>
                          <button className="admin-btn-sm primary" onClick={() => openIntelligenceTools(item)}>
                            🔍 Research Tools
                          </button>
                          <button className="admin-btn-sm secondary" onClick={() => generateMonthlyBriefing(item)}>
                            📊 Generate Report
                          </button>
                        </td>
                      </tr>
          ...
          {activeTab === 'partner-applications' && (
            <div className="admin-card">
              <div className="card-header">
                ...
                <p className="admin-subtitle">Mexico suppliers wanting to join the network</p>
              </div>
              ...
              <div className="table-container">
                <table className="admin-table">
                  ...
                  <tbody>
                    {pendingPartnerApplications?.map((app, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <button className="admin-btn-sm primary">Review</button>
                          <button className="admin-btn-sm success">Approve</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
          ...
          {activeTab === 'service-calendar' && (
            <div className="admin-card">
              <div className="card-header">
                <h1 className="admin-title">📅 Service Calendar</h1>
                <p className="admin-subtitle">Scheduled consultations and service delivery timeline</p>
              </div>
          ...
          {activeTab === 'client-management' && (
            <div className="admin-card">
              <div className="card-header">
                ...
                <p className="admin-subtitle">Manage relationships with Mexico trade service clients</p>
              </div>
                  ...
                  <tbody>
                    {serviceClients?.map((client, index) => (
                      <tr key={index}>
                        ...
                        <td>{client.services_used?.join(', ')}</td>
                        <td className="font-mono text-green-600">${client.total_revenue}</td>
                        ...
                        <td>
                          <button className="admin-btn-sm primary">Contact</button>
                          <button className="admin-btn-sm secondary">View History</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
