      ...
      {analysisComplete && analysisResult && (
        <div className="analysis-results">
          ...
          <div className="risk-section">
            ...
            <ul className="risk-list">
              {analysisResult.compliance_risks.map((risk, idx) => (
                <li key={idx} className="risk-item high-risk">❌ {risk}</li>
              ))}
            </ul>
          </div>

          {analysisResult.component_risks?.length > 0 && (
            <div className="risk-section">
          ...
          <div className="risk-section">
            ...
            <div className="tariff-exposure-box">
              {analysisResult.tariff_exposure}
            </div>
          </div>
    ...
    <div className="workflow-stage">
      ...
      <div className="ai-analysis-summary">
        ...
        <div className="ai-findings">
          {aiAnalysis?.compliance_risks?.length > 0 && (
          ...
          {aiAnalysis?.component_risks?.length > 0 && (
            <div className="finding-section">
