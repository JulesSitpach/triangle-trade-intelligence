  ...
  const generateAndDownloadPDF = async (certificateResult, inputData) => {
    try {
      ...
      doc.setProperties({
        ...
        author: 'Triangle Trade Intelligence Platform',
        creator: 'Triangle Trade Intelligence USMCA Platform',
      ...
      doc.text('Generated by Triangle Trade Intelligence Platform - Professional verification recommended before submission', 105, 285, { align: 'center' });
