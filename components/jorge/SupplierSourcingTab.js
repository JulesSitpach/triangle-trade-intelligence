          ...
          <div className="modal-content sourcing-modal">
            ...
            <div className="verification-progress">
              <div className="progress-steps">
                <div className={`step ${sourcingModal.currentStage >= 1 ? 'active' : ''}`}>1. Client Context</div>
                <div className={`step ${sourcingModal.currentStage >= 2 ? 'active' : ''}`}>2. Network Research</div>
                <div className={`step ${sourcingModal.currentStage >= 3 ? 'active' : ''}`}>3. Validation Analysis</div>
                <div className={`step ${sourcingModal.currentStage >= 4 ? 'active' : ''}`}>4. Connection Report</div>
              </div>
            </div>
