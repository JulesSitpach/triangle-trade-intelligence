  ...
  return (
    <div className="workflow-stage">
      ...
      <div className="workflow-subscriber-summary">
        ...
        {(subscriberData?.component_origins || serviceDetails?.component_origins)?.length > 0 && (
      ...
      {classificationComplete && classificationResult && (
        <div className="workflow-classification-result">
          ...
          <div className="ai-findings-section">
            ...
            {classificationResult.similar_products && classificationResult.similar_products.length > 0 && (
