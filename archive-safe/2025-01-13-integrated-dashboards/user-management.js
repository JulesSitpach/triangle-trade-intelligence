      ...
      try {
        ...
        if (analyticsResponse.ok) {
          ...
          setAnalytics({
            ...
            active_users: analyticsData.active_users || 0,
            trial_users: analyticsData.trial_users || 0,
            total_mrr: analyticsData.total_mrr || 0,
            churn_rate: analyticsData.churn_rate || 0,
            avg_savings_per_user: analyticsData.avg_savings_per_user || 0
          });
      ...
      <TriangleLayout>
        <div className="main-content">
          <div className="text-center">
            ...
            <p className="text-muted">Loading user management system... (mounted: {mounted.toString()}, loading: {isLoading.toString()})</p>
          </div>
        </div>
      </TriangleLayout>
    );
