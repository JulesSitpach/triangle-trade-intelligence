...
This is a no-pressure follow-up. Respond only if helpful for your evaluation.`;
  ...
  return (
    <div className="card">
      <h3 className="section-title">Email Template Generator</h3>
      ...
      <div className="form-section">
        <h4 className="card-title mb-3">Customize Email Content</h4>
        <div className="grid-2-cols">
          <div>
            <label className="form-label">
              Recipient Name
      ...
      <div className="mb-4">
        <div className="header-actions">
          <h4 className="card-title">Generated Email</h4>
