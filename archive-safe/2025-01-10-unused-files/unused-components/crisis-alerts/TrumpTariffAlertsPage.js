...
export default function TrumpTariffAlertsPage({ customerId, companyName }) {
  ...
  const getSeverityIcon = (severity) => {
    switch (severity) {
      ...
      default: return <Bell className="icon-md" />;
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-body">Loading Trump-era tariff alerts...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          {alerts.length === 0 ? (
            <div className="text-center py-12">
              <Bell className="icon-lg mx-auto mb-4" />
              <h3 className="card-title mb-2">No alerts yet</h3>
              ...
              {alerts.map((alert, index) => (
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="ml-4 content-card">
                      <div className="flex items-start justify-between">
                        <div className="content-card">
                          ...
                          {alert.estimated_impact && (
                            <div className="bg-gray-50 rounded-lg p-4 mb-4">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                                <div>
                                  <p className="text-body">Annual Cost Increase</p>
                                  <p className="font-bold text-red-600">
                                    {formatCurrency(alert.estimated_impact.cost_increase)}
                                  </p>
                                </div>
                                <div>
                                  <p className="text-body">Rate Increase</p>
                                  <p className="font-bold text-orange-600">
                                    +{alert.estimated_impact.percentage_increase?.toFixed(1)}%
                                  </p>
                                </div>
                                <div>
                                  <p className="text-body">Products Affected</p>
                          ...
                          <div className="text-sm text-body mb-4 whitespace-pre-line">
                            {alert.alert_message}
                          </div>
