...
export class BatchQueryOptimizer {
  ...
  // Consolidated: USE_QUERY_CACHING is auto-enabled when USE_OPTIMIZED_QUERIES is true
  static config = {
    ...
    cacheEnabled: process.env.NEXT_PUBLIC_USE_OPTIMIZED_QUERIES === 'true', // Consolidated flag
