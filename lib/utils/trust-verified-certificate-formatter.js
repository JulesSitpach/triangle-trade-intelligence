...
${cert.preference_criterion || 'B'} - ${cert.preference_explanation || 'The good is originating because it satisfies the requirements for preferential tariff treatment under the USMCA'}
...
Component Breakdown: ${this.formatComponentBreakdown(cert.additional_information?.component_breakdown)}
...
Generation Platform: ${cert.generation_info?.generated_by || 'Triangle Intelligence USMCA Compliance Platform'}
...
═══════════════════════════════════════════════════════════════════════════
Generated by Triangle Intelligence USMCA Compliance Platform
