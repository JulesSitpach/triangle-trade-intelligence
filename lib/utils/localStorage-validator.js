...
const EXPIRY_TIMES = {
  'triangle-foundation': parseInt(process.env.CACHE_TTL_USER_SESSIONS) * 1000 || (24 * 60 * 60 * 1000), // Environment configurable
  'triangle-product': parseInt(process.env.CACHE_TTL_USER_SESSIONS) * 1000 || (12 * 60 * 60 * 1000),    // Environment configurable
  'triangle-routing': parseInt(process.env.CACHE_TTL_USER_SESSIONS) * 1000 || (12 * 60 * 60 * 1000),    // Environment configurable
  'triangle-partnership': parseInt(process.env.CACHE_TTL_USER_SESSIONS) * 1000 || (24 * 60 * 60 * 1000), // Environment configurable
