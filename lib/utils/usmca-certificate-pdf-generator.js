/**
 * USMCA Certificate PDF Generator - Optimized Professional Layout
 *
 * Compact middle sections to give authorization section proper breathing room.
 *
 ...
 * - Certification Statement: 14mm (compressed from 16mm) - smaller font
 ...
 * - Font sizes: 13px header, 12px subheader, 9px data, 8px labels/statement
 *
 * October 30, 2025 - Space optimization: compress middle, expand authorization
 */
...
export async function generateUSMCACertificatePDF(certificateData, options = {}) {
  ...
  try {
    ...
    // ========== CERTIFICATION STATEMENT (COMPACT) ==========
    ...
    doc.text(wrappedCert, LAYOUT.page.margin + 3, y + 4);  // Less top spacing
