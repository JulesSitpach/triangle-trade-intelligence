...
export async function generateUSMCACertificatePDF(certificateData) {
  ...
  doc.setFontSize(6);
  doc.text('COUNTRY', margin + 1, y + 19);
  doc.setFontSize(7);
  doc.text(certificateData.certifier?.country || certificateData.exporter?.country || '', margin + 1, y + 22);

  doc.setFontSize(6);
  doc.text('PHONE', margin + 1, y + 24);
  doc.setFontSize(7);
  doc.text(certificateData.certifier?.phone || certificateData.exporter?.phone || '', margin + 1, y + 27);

  doc.setFontSize(6);
  doc.text('EMAIL', margin + 1, y + 29);
  doc.setFontSize(7);
  const certEmail = wrapText(certificateData.certifier?.email || certificateData.exporter?.email || '', halfWidth - 10);
  doc.text(certEmail, margin + 1, y + 32);
  ...
  doc.setFontSize(6);
  doc.text('COUNTRY', margin + halfWidth + 1, y + 19);
  doc.setFontSize(7);
  doc.text(certificateData.exporter?.country || '', margin + halfWidth + 1, y + 22);

  doc.setFontSize(6);
  doc.text('PHONE', margin + halfWidth + 1, y + 24);
  doc.setFontSize(7);
  doc.text(certificateData.exporter?.phone || '', margin + halfWidth + 1, y + 27);

  doc.setFontSize(6);
  doc.text('EMAIL', margin + halfWidth + 1, y + 29);
  doc.setFontSize(7);
  const expEmail = wrapText(certificateData.exporter?.email || '', halfWidth - 10);
  doc.text(expEmail, margin + halfWidth + 1, y + 32);
  ...
  doc.text('COUNTRY', margin + 1, y + 19);
  doc.setFontSize(7);
  doc.text(certificateData.producer?.country || certificateData.exporter?.country || '', margin + 1, y + 22);

  doc.setFontSize(6);
  doc.text('PHONE', margin + 1, y + 24);
  doc.setFontSize(7);
  doc.text(certificateData.producer?.phone || certificateData.exporter?.phone || '', margin + 1, y + 27);

  doc.setFontSize(6);
  doc.text('EMAIL', margin + 1, y + 29);
  doc.setFontSize(7);
  const prodEmail = wrapText(certificateData.producer?.email || certificateData.exporter?.email || '', halfWidth - 10);
  doc.text(prodEmail, margin + 1, y + 32);
  ...
  doc.text('COUNTRY', margin + halfWidth + 1, y + 19);
  doc.setFontSize(7);
  doc.text(certificateData.importer?.country || '', margin + halfWidth + 1, y + 22);

  doc.setFontSize(6);
  doc.text('PHONE', margin + halfWidth + 1, y + 24);
  doc.setFontSize(7);
  doc.text(certificateData.importer?.phone || '', margin + halfWidth + 1, y + 27);

  doc.setFontSize(6);
  doc.text('EMAIL', margin + halfWidth + 1, y + 29);
  doc.setFontSize(7);
  const impEmail = wrapText(certificateData.importer?.email || '', halfWidth - 10);
  doc.text(impEmail, margin + halfWidth + 1, y + 32);
