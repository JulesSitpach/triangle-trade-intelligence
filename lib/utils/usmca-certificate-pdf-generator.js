...
export async function generateUSMCACertificatePDF(certificateData, options = {}) {
  ...
  // ✅ REMOVED: Column 8 - Origin Criterion default || 'B' (line 465)
  // REASON: Printing 'B' when AI didn't determine criterion = FALSE CERTIFICATION
  // FIX: Print actual criterion or blank if undefined (will cause validation error before PDF)
  doc.text(certificateData.preference_criterion || '', col8X + 1, dataY);
