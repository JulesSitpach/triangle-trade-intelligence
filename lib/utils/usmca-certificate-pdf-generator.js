...
export async function generateUSMCACertificatePDF(certificateData) {
  ...
  const certifierType = certificateData.certifier?.type || 'Exporter';
  const boxSize = 3;
  const boxY = y + 2;
  ...
  doc.setFontSize(7);
  const certAddr = wrapText(certificateData.certifier?.address || certificateData.exporter?.address || '', halfWidth - 4);
  doc.text(certAddr, margin + 1, y + 15);
  doc.setFontSize(6);
  doc.text('TAX IDENTIFICATION NUMBER', margin + 1, y + 25);
  doc.setFontSize(7);
  doc.text(certificateData.exporter?.tax_id || '', margin + 1, y + 28);
  ...
  doc.setFontSize(7);
  const expAddr = wrapText(certificateData.exporter?.address || '', halfWidth - 4);
  doc.text(expAddr, margin + halfWidth + 1, y + 15);
  doc.setFontSize(6);
  doc.text('TAX IDENTIFICATION NUMBER', margin + halfWidth + 1, y + 25);
  doc.setFontSize(7);
  doc.text(certificateData.exporter?.tax_id || '', margin + halfWidth + 1, y + 28);
  ...
  doc.text('ADDRESS', margin + 1, y + 12);
  doc.setFontSize(7);
  const prodAddr = wrapText(certificateData.producer?.address || certificateData.exporter?.address || '', halfWidth - 4);
  ...
  doc.text('TAX IDENTIFICATION NUMBER', margin + halfWidth + 1, y + 25);
  doc.setFontSize(7);
  doc.text(certificateData.importer?.tax_id || '', margin + halfWidth + 1, y + 28);
  ...
  doc.setFontSize(7);
  doc.text(certificateData.exporter?.phone || '', margin + 100, y + 37);
  doc.setFontSize(6);
  doc.text('12g. EMAIL', margin + 140, y + 37);
  doc.setFontSize(7);
  doc.text(certificateData.exporter?.email || '', margin + 155, y + 37);
