...
export async function generateUSMCACertificatePDF(certificateData, options = {}) {
  ...
  try {
    ...
    const certNumX = LAYOUT.page.width - LAYOUT.page.margin - certNumWidth;
    const certNumY = LAYOUT.page.margin + 2;
