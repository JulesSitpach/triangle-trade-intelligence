...
export async function generateUSMCACertificatePDF(certificateData) {
  ...
  doc.text(certCountry, margin + 1, y + 22);
  ...
  doc.text(expCountry, margin + halfWidth + 1, y + 22);
  ...
  doc.text(prodCountry, margin + 1, y + 22);
  ...
  doc.text(impCountry, margin + halfWidth + 1, y + 22);
