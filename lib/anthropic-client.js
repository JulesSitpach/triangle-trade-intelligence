 ...
 * Standardized AI calls for Triangle Trade Intelligence Platform
 * Cost-optimized with Claude 3.5 Haiku for business analysis
 */

/**
 * Standard Anthropic API call for Triangle Trade Intelligence
...
export async function callAnthropicAPI(prompt, options = {}) {
  const {
    maxTokens = 2000,
    temperature = 0.7,
    model = 'claude-haiku-4-20250514', // Cost-effective choice
    parseJSON = true
  } = options;
