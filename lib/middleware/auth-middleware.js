...
function verifySession(cookieValue) {
  try {
    ...
    if (!secret) {
      throw new Error('Authentication secret not configured in environment variables');
    }
...
/**
 * Verify authentication and return user info (for direct use in API handlers)
 * Returns: { authenticated: boolean, user?: { id, email, role, isAdmin, companyName } }
 */
