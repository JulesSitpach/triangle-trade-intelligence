...
export const WORKFLOW_FORM_SCHEMA = {
  ...
  substantial_transformation: 'boolean',  // ✅ Manufacturing involves value-add (checkbox)
  manufacturing_process: 'string|null',  // ✅ Manufacturing process description (optional, for context only)

  // Labor cost calculation - SIMPLIFIED (Nov 21, 2025)
  has_labor_cost_data: 'boolean',      // ✅ Does user have actual labor cost data?
  labor_cost_annual: 'number',         // ✅ Annual direct manufacturing labor cost in USD
