...
{
  "qualified": boolean,
  "rvc_percentage": ${totalNAContent},
  "threshold_required": ${threshold.rvc},
  "preference_criterion": "A|B|C|D or null",
  "summary": "One sentence result: e.g. 'Qualified with 82% RVC (threshold 65%)', or 'Not qualified - 58% vs 65% required'"
}`;
