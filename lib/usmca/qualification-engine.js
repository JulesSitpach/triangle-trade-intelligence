...
1. If processes are MORE complex than typical ${industry}: increase by 2-5%
2. If processes are LESS complex than typical ${industry}: decrease by 2-5%
3. If no process details: use baseline ${laborValueAdded}% as-is
4. Stay within USMCA Article 4.5 range (5-25%)

Return your final labor_credit_percentage (baseline ± adjustments).` : `⚠️ NO LABOR CREDIT DATA FOUND for ${industry}.
