...
<head>
  ...
  <title>Welcome to TradeFlow Intelligence</title>
</head>
<body style="margin: 0; padding: 0; font-family: 'Arial', sans-serif; background-color: #f4f4f4;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #134169 0%, #2563eb 100%); padding: 40px 30px; text-align: center;">
              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 700;">Welcome to TradeFlow Intelligence</h1>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 20px; color: #333333; font-size: 16px; line-height: 1.6;">
                Thank you for joining TradeFlow Intelligence! We're excited to help you optimize your USMCA compliance and maximize tariff savings.
              </p>
          ...
          <tr>
            <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0 0 10px; color: #666666; font-size: 14px;">
                © ${new Date().getFullYear()} TradeFlow Intelligence. All rights reserved.
              </p>
  ...
  return await sendEmail({
    to: user.email,
    subject: 'Welcome to TradeFlow Intelligence - Let\'s Get Started!',
    html
  });
}
...
<body style="margin: 0; padding: 0; font-family: 'Arial', sans-serif; background-color: #f4f4f4;">
  ...
  return await sendEmail({
    to: user.email,
    subject: 'Your USMCA Certificate is Ready - TradeFlow Intelligence',
    html
  });
}
...
<body style="margin: 0; padding: 0; font-family: 'Arial', sans-serif; background-color: #f4f4f4;">
  ...
  return await sendEmail({
    to: user.email,
    subject: `Service Purchase Confirmed: ${service.type} - TradeFlow Intelligence`,
    html
  });
}
...
<body style="margin: 0; padding: 0; font-family: 'Arial', sans-serif; background-color: #f4f4f4;">
  ...
  return await sendEmail({
    to: user.email,
    subject: `Welcome to ${tierNames[subscription.tier]} - TradeFlow Intelligence`,
    html
  });
}
