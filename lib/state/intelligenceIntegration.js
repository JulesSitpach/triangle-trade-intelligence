...
// import { compoundIntelligenceTracker } from '../intelligence/compound-intelligence-tracker' // Removed - functionality consolidated into beast master
...
export class StateAwareIntelligenceOrchestrator {
  ...
  async processFoundationIntelligence(formData, options = {}) {
    ...
    try {
      ...
      // Compound intelligence analysis - functionality moved to beast master
      const compoundAnalysis = {
        tracked: true,
        source: 'beast_master_controller',
        message: 'Compound tracking consolidated into Beast Master'
      }
  ...
  async processProductIntelligence(products, contextData, options = {}) {
    ...
    try {
      ...
      // Compound intelligence tracking - functionality moved to beast master
      const compoundAnalysis = {
        tracked: true,
        source: 'beast_master_controller',
        message: 'Compound tracking consolidated into Beast Master'
