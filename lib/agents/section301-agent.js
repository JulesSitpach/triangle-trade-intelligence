...
- New products added to lists
- Some exclusions granted (check Federal Register)
    ...
    try {
      ...
      if (error || !data) {
        ...
        return {
          ...
          fallback_rate: 0,
          fallback_warning: '⚠️ Unable to determine Section 301 rate - assuming 0% but Chinese goods typically incur 7.5%-25%'
        };
      }
