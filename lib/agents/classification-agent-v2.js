...
- **SMART SEARCHING**:
  1. Start with specific keywords: "brake friction ceramic non-asbestos"
  2. If no results, tool automatically tries "brake friction ceramic" (drops modifiers)
  3. If still no results, tool tries just "brake" (primary keyword)
  4. Result includes `search_strategy` telling you how results were found
...
- **REASONING EXAMPLE**:
  "Brake backing plates, steel" → First try: search("brake backing plates steel")
  → No results → Tool tries: search("brake") → Returns 18 results
  → I see 68138100 "Brake linings and pads" (Chapter 68 - ceramics/friction materials)
  → But I need STEEL backing plates, not ceramic linings
  → Try again: search("steel plates", chapter="73") → Should find steel articles
