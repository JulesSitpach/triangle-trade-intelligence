...
=== BUSINESS CONTEXT ===
Company: ${additionalContext.companyName || 'Not provided'}
Business Type: ${additionalContext.businessType || 'Not provided'}
Annual Trade Volume: ${additionalContext.tradeVolume || 'Not provided'}
Manufacturing Location: ${additionalContext.manufacturingLocation || 'Not provided'}
Export Destination: ${additionalContext.exportDestination || 'Not provided'}
Primary Supplier: ${additionalContext.primarySupplier || 'Not provided'}
...
3. **Business type and industry** - ${additionalContext.businessType}
...
Return JSON:
{
  ...
  "usmcaRate": "${isUSMCAOrigin ? 'USMCA preferential rate as decimal (typically 0 for duty-free when origin is US/MX/CA)' : 'null (origin is not USMCA country)'}",
  "alternativeCodes": [
    {
...
IMPORTANT:
- If component origin is US/MX/CA, typically usmcaRate should be 0 (duty-free)
- If component origin is outside USMCA, usmcaRate should be null
