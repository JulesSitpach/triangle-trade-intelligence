...
SEARCH STRATEGY:
Before calling search_database, extract:
- Primary material (aluminum, steel, plastic, etc.) → determines chapter
- Product type (housing, bracket, circuit, etc.)
- Relevant chapter (aluminum=76, steel=73, plastic=39, electronics=85)
...
- DO NOT classify displays as printed circuits (8534) - displays are complete assemblies, NOT bare PCBs
- Touchscreens → display modules, NOT input devices

Search with SIMPLIFIED terms:
- "aluminum housing" NOT "die-cast aluminum housing with anodized finish, powder-coated matte black"
- "LCD display" or "flat panel" NOT full technical specs
- Search by chapter if keyword search fails
