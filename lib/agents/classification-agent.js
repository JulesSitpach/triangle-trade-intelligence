...
Value Percentage: ${componentOrigins[0].value_percentage}%`
    ...
    const prompt = `Classify this component using the US Harmonized Tariff Schedule:
...
HTS hierarchy: Chapter (2) → Heading (4) → Subheading (6) → Full (8 digits)
If uncertain about the full 8-digit code, use the broader heading with zeros.
