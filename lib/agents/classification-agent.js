...
Use search_us_hts_codes tool to find the correct code in the database before responding.
  ...
  "alternative_codes": [
    ...
    const tools = [{
      ...
      function: {
        ...
        description: 'Search tariff_intelligence_master table for HTS codes',
        parameters: {
          type: 'object',
          properties: {
            keywords: { type: 'string', description: 'Search keywords' },
            chapter: { type: 'string', description: 'First 2 digits' },
            heading: { type: 'string', description: 'First 4 digits' }
          }
        }
      }
    }];
    ...
    const result = await this.execute(prompt, {
      ...
      temperature: 0.3,
      tools,
      toolHandler: async (name, args) => await this.searchHTSDatabase(args)
    });
