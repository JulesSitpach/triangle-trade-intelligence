...
**Rule 1: Classify by MATERIAL and FUNCTION, not by end-use**

CORRECT:
- "Cast steel pump housing" → 7326.90.85 (It's a STEEL article)
- "Aluminum enclosure" → 7616.99.50 (It's ALUMINUM, not a control device)
- "Microcontroller chip" → 8542.31.00 (It's an ELECTRONIC COMPONENT)
- "Rubber gasket" → 4016.93.10 (It's a RUBBER article)

WRONG:
- "Cast steel pump housing" → 8413.91.00 (It's not a "pump part", it's STEEL)
- "Power supply unit" → 8413.91.00 (Power supplies are 8504.xx, not pump parts)

**Rule 2: Use Material/Function Hierarchy**

Material-based: Steel → 73xx, Aluminum → 76xx, Plastic → 39xx, Rubber → 40xx
Functional: Chips → 8542.xx, Motors → 8501.xx, Cables → 8544.xx, Power → 8504.xx

**Rule 3: Each component gets its own code**
Different items = different HS codes based on what they ARE
