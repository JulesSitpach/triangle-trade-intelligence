...
⚖️ CLASSIFICATION CONTEXT - READ ALL BEFORE CLASSIFYING:

Final Product: ${additionalContext.overallProduct}
Industry: ${additionalContext.industryContext}
This Component's Role: Part of the above product

CRITICAL INSTRUCTION:
Classify this component considering its role in the FINAL PRODUCT, not in isolation.

• Functional components (displays, circuits, motors, sensors) → Classify by function (Ch 84/85/90)
  Material (glass, plastic, metal) is incidental - ignore for functional electronics/machinery

• Structural components (housings, brackets, fasteners, wire) → Classify by material (Ch 39/73/76)
  Material IS primary - aluminum housing goes to Ch 76, not Ch 85

APPLY GRI HIERARCHY WITH CONTEXT:
1. What is this component? (functional sub-assembly or structural part?)
2. What chapter does that type belong to?
3. Refine to specific code within that chapter

If the component is an electronic display, circuit board, or sensor → Chapter 85 (even if it mentions glass)
If the component is a housing or bracket → Material chapter (76 for aluminum, 73 for steel)
...
Return JSON:
{
  ...
  "confidence": 0-100,
  "component_type": "functional|structural",
  "primary_material": "aluminum|steel|plastic|copper|electronic|mechanical|etc",
  "classification_methodology": "function_based|material_based",
  "gri_step_1_component_type": "Type A (Functional) or Type B (Structural)?",
  "gri_step_2_form": "What form/processing?",
  "gri_step_3_function": "What function and how does it refine classification?",
  "material_chapter_match": true|false,
  "audit_risk": "low|medium|high",
  "legal_basis": "GRI Rule + Component type rationale",
  "explanation": "2-3 sentences explaining classification with component type and context",
