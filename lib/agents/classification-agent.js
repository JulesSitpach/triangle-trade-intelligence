...
HTS is hierarchical: Chapter (2 digits) → Heading (4 digits) → Subheading (6 digits) → Full code (8 digits).
When you don't know the exact 8-digit code, use the broader heading and pad with zeros.
Read chapter descriptions carefully - they contain critical exclusions like "without", "not assembled", "unmounted".
Match the component's ACTUAL STATE to the HTS description literally.

Return your genuine confidence level based on how certain you are about the classification.
