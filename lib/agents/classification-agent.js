...
• What is its PRIMARY FUNCTION?
  ...
  ❗ FUNCTION-FIRST RULE:
  If component has a specific working function, it's likely classified by function:
  → Pumps, motors, hydraulics, electronics → Machinery chapters (84, 85)
  → Fasteners, fittings, valves → Functional parts chapters
  → Textiles, apparel → Fabric/garment chapters
