/**
 * Triangle Intelligence Platform - HS Code Classification Agent
 * Copyright © 2025 Triangle Intelligence Platform. All rights reserved.
 *
 * PROPRIETARY AND CONFIDENTIAL
 * Unauthorized copying, modification, or distribution prohibited.
 * This file contains proprietary AI-powered HS code classification logic.
 */
...
5. VALIDATE your choice:
   ...
   - **⚠️ CRITICAL: CHECK FOR CONTRADICTIONS** - If the description says "NON-asbestos", the HTS description CANNOT say "containing asbestos". If it says "synthetic", HTS cannot say "natural". If it says "electric", HTS cannot say "manual". The HTS code must NOT contradict the input description.
...
- "FUNCTION: Friction material (Chapter 68), MATERIAL: NON-asbestos ceramic, FORM: Brake linings. Searched: 'brake friction ceramic non-asbestos'. Database returned 6813.20.00 (asbestos) and 6813.81.00 (non-asbestos). CHOSE 6813.81.00 because description says 'NON-asbestos' - cannot use code that says 'containing asbestos'. Confidence 90% because contradiction check passed."
`}
...
- **⚠️ CONTRADICTION CHECK: If description says "NON-X" (non-asbestos, non-toxic, non-electric), HTS code CANNOT say "containing X" or "X-type". This is INSTANT DISQUALIFICATION.**
