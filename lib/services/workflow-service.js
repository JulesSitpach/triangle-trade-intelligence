...
class WorkflowService {
  ...
  async processCompleteWorkflow(formData) {
    ...
    try {
      ...
      // 🔒 SECURITY: Include workflow_session_id for completion tracking and AI regeneration protection
      const requestData = {
        ...formData,
        workflow_session_id: typeof window !== 'undefined' ? localStorage.getItem('workflow_session_id') : null
      };
