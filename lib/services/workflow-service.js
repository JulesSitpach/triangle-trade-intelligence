    ...
    try {
      ...
      await logDevIssue({
        ...
        data: {
          ...
          fallback: 'using default dropdown options'
        }
      });
  ...
  async getTrustIndicators() {
    try {
      ...
      await logDevIssue({
        ...
        severity: 'medium',
        component: 'database_service',
        message: 'Failed to load trust indicators from API',
        data: {
          error: error.message,
          stack: error.stack,
          endpoint: TRUST_ENDPOINTS.trustMetrics,
          fallback: 'using default trust indicators'
        }
      });
