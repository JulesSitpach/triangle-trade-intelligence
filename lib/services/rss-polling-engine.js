...
✅ "USMCA regional content threshold for automotive increased to 75%" → Score 8
   (Keywords: "USMCA", "regional value content", "automotive")
...
❌ "Tip wage regulations updated" → Score 1 (keyword: "tip wage" = automatic reject)
❌ "Committee meeting scheduled" → Score 1 (keyword: "committee" = automatic reject)
❌ "China GDP growth slows to 4%" → Score 1 (no trade keywords: no "tariff", "trade policy", "import/export action")
❌ "Tesla stock drops on earnings miss" → Score 1 (no trade keywords)
