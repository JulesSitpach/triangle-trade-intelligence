...
export class ProfessionalReferralSystem {
        ...
        primary_services: [
          {
            ...
            description: 'Contact trade compliance expert for comprehensive review',
            urgency: 'standard'
          }
        ],
        specialized_services: [],
  ...
  async generateReferralResponse(evaluation, originalRequest = {}) {
    try {
      const response = {
        ...
        contact_information: {
          message: 'Contact a trade compliance expert for professional assistance',
      ...
      return {
        ...
        contact_information: {
          message: 'Contact a trade compliance expert immediately',
  ...
  async generateNextSteps(evaluation) {
    ...
    if (evaluation.severity === 'high') {
      steps.push({
        step: 1,
        action: 'Contact trade compliance expert immediately',
        urgency: 'urgent',
