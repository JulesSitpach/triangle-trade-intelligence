// Triangle Intelligence - Workflow Data Flow Connector
...
class WorkflowDataConnector {
  ...
  async captureCompanyData(stepData, sessionId) {
    ...
    const userProfile = {
      ...
      country: stepData.country || 'US',
      status: 'trial',
      subscription_tier: 'trial',
      workflow_completions: 0,
      certificates_generated: 0,
      total_savings: 0,
      trade_volume: parseFloat(stepData.trade_volume || stepData.annual_trade_volume || '0'),
    ...
    const companyProfile = {
      ...
      trade_volume: stepData.annual_trade_volume || stepData.trade_volume || '0',
