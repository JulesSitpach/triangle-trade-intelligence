...
class WorkflowDataConnector {
  ...
  async captureCompanyData(stepData, sessionId) {
    ...
    const userProfile = {
      ...
      country: stepData.country || stepData.company_country,  // ✅ No hardcoded 'US' - use validated value
      status: 'trial',
      subscription_tier: 'trial',
      workflow_completions: 0,
      certificates_generated: 0,
      total_savings: 0,
      trade_volume: parseTradeVolume(stepData.trade_volume || stepData.annual_trade_volume) || 0,
    ...
    const companyProfile = {
      ...
      trade_volume: parseTradeVolume(stepData.annual_trade_volume || stepData.trade_volume) || 0,
    ...
    await this.updateWorkflowSession(sessionId, {
      ...
      company_name: stepData.company_name,
      business_type: stepData.business_type,
      company_country: stepData.country || stepData.company_country,
      trade_volume: parseTradeVolume(stepData.trade_volume || stepData.annual_trade_volume) || 0,
