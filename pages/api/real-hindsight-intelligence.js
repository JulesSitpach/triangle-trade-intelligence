...
async function getActualSavingsData(origin) {
  ...
  return {
    ...
    insight: `Route option ${Object.keys(stageAnalysis).reduce((best, stage) => 
...
- Best Route: ${actualSavings.bestStage}
...
**Key Recommendations:**
1. **Route Optimization**: Route option ${actualSavings.bestStage} shows highest success rates for your business type
