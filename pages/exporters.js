...
export default function ExportersPage() {
  ...
  const [activeTab, setActiveTab] = useState('exporter') // Default to exporter
    ...
    <>
      ...
      <section className="main-content" style={{ paddingTop: '1rem' }}>
        <div className="container-app text-center">
          <h2 className="section-header-title">Ready to Win More B2B Contracts?</h2>
          <p className="section-header-subtitle">
            Join exporters who are providing USMCA certificates and winning contracts with Triangle Intelligence.
          </p>
