                    ...
                    <div className="bloomberg-grid bloomberg-grid-4">
                      <div className="bloomberg-card">
                        <div className="bloomberg-metric">
                          ...
                          <div className="bloomberg-metric-value">{foundationData?.companyName || 'Sample Company'}</div>
                          <div className="bloomberg-card-subtitle">{foundationData?.businessType || 'Electronics'} {ready ? t('partnership.businessProfile.industry', 'industry') : 'industry'}</div>
                        </div>
                      </div>
                      ...
                      <div className="bloomberg-card">
                        <div className="bloomberg-metric">
                          ...
                          <div className="bloomberg-metric-value">{foundationData?.importVolume || '$1M - $5M'}</div>
                      ...
                      <div className="bloomberg-card">
                        <div className="bloomberg-metric">
                          ...
                          <div className="bloomberg-metric-value">{foundationData?.timelinePriority || 'Cost Savings'}</div>
                      ...
                      {selectedRoute && (
                        <div className="selection-summary">
                          <div className="summary-content">
                            ...
                            {' for '}{foundationData?.companyName || 'your business'} ({foundationData?.businessType || 'Electronics'} with {foundationData?.importVolume || '$1M - $5M'} annual volume).
                          </div>
                        </div>
                      )}
                    </div>
                      ...
                      <div className="strategy-summary">
                        <div className="summary-message">
                          <strong>{ready ? t('partnership.implementation.strategyConfirmed', 'Partnership Strategy Confirmed!') : 'Partnership Strategy Confirmed!'}</strong> Your {
                            ...
                            'dual-market'
                          } {ready ? t('partnership.implementation.optimizedFor', 'partnership strategy is optimized for') : 'partnership strategy is optimized for'} {foundationData?.businessType || 'Electronics'} {ready ? t('partnership.implementation.businessesProvenSuccess', 'businesses with proven success in our network.') : 'businesses with proven success in our network.'}
                        </div>
                      </div>
                    </div>
                  )}
