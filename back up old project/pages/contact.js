    ...
    try {
      ...
      if (response.ok) {
        ...
        setEnterpriseStats({
          ...
          responseTime: 24,
          enterpriseClients: (data.stats.triangleRouting.stage1 + data.stats.triangleRouting.stage2) || 324,
          successRate: 94.7
        })
      }
    } catch (error) {
            ...
            <div className="contact-success">
              <div className="contact-success-content">
                ...
                <div className="contact-success-actions">
                  <Link href="/stage1" className="bloomberg-btn bloomberg-btn-primary">
