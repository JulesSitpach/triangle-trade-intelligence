...
import DatabaseIntelligenceBridge, { getIntelligentShipping } from '../lib/database-intelligence-bridge'
    ...
    try {
      ...
      if (partnershipData) {
        try {
          ...
          console.warn('Could not parse Stage 4 data:', e)
        }
      }
          ...
          <div className="savings-results">
            ...
            <div className="results-action">
              ...
              <div className="action-buttons">
                <button onClick={proceedToStage8} className="bloomberg-btn bloomberg-btn-primary">
